...
//!
//! ```
//! use der_verified::x509_tbs_certificate::parse_tbs_certificate;
//!
//! // A minimal, valid v1 TBSCertificate: no [0] version wrapper (DEFAULT v1), no extensions.
//! #[rustfmt::skip]
...
//! ];
//!
//! let tbs = parse_tbs_certificate(&V1_MINIMAL_TBS).unwrap();
//! assert_eq!(tbs.version, 0); // DEFAULT v1, [0] wrapper absent
//! assert_eq!(tbs.signature.algorithm_oid, &[0x2b, 0x65, 0x70]); // Ed25519
//! ```
