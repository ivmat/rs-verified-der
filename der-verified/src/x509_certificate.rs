...
//!
//! // A complete v3 Ed25519 certificate (tbsCertificate + signatureAlgorithm + signatureValue),
//! // byte-for-byte the module's own test fixture.
//! #[rustfmt::skip]
...
//! assert_eq!(cert.tbs_certificate.version, 2); // v3
//! assert_eq!(cert.signature_algorithm.algorithm_oid, &[0x2b, 0x65, 0x70]); // Ed25519
//! ```
