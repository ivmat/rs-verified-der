...
**L3 — bounded, with Kani (CBMC under the hood).** 203 proof harnesses across 33 modules. Each proves,
...
Plus 485 concrete and regression tests (including seeded-bad specimens), `#![forbid(unsafe_code)]`,
