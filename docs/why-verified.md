...
**L3 — bounded, with Kani (CBMC under the hood).** 183 proof harnesses across 30 modules. Each proves,
...
Plus 431 concrete and regression tests (including seeded-bad specimens), `#![forbid(unsafe_code)]`,
