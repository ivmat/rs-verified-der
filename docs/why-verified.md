...
**L3 — bounded, with Kani (CBMC under the hood).** 188 proof harnesses across 31 modules. Each proves,
...
Plus 462 concrete and regression tests (including seeded-bad specimens), `#![forbid(unsafe_code)]`,
