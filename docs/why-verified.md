...
**L3 — bounded, with Kani (CBMC under the hood).** 180 proof harnesses across 29 modules. Each proves,
...
Plus 397 concrete and regression tests (including seeded-bad specimens), `#![forbid(unsafe_code)]`,
