...
**L3 — bounded, with Kani (CBMC under the hood).** 191 proof harnesses across 32 modules. Each proves,
...
Plus 472 concrete and regression tests (including seeded-bad specimens), `#![forbid(unsafe_code)]`,
