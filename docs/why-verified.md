...
**L3 — bounded, with Kani (CBMC under the hood).** 201 proof harnesses across 33 modules. Each proves,
...
Plus 483 concrete and regression tests (including seeded-bad specimens), `#![forbid(unsafe_code)]`,
